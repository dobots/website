  ...
  class YouTubeTag < Liquid::Tag
    ...
    def render(context)
      ...
      if @videoid
        ...
        intrinsic = ((@height.to_f / @width.to_f) * 45)
        ...
        video = %Q{<div class="bt-video-container" style="position:relative;padding-bottom:#{padding_bottom};padding-top:10px;height:0;overflow:hidden"><iframe width="#{@width}" height="#{@height}" src="http://www.youtube.com/embed/#{@videoid}?rel=0" frameborder="0" allowfullscreen="true"> </iframe></div>}
      else
